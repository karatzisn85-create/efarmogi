...
const ALLOWED_INVOKE = new Set([
  'add-document-category','add-files-to-group','authenticate',
  ...
  'create-project-lock','create-user','delete-backup','delete-document-category',
  ...
  'get-file-path','get-folder-contents','get-projects','get-prosklisi-files',
  ...
  'load-entaxi-data','load-notes','load-organized-egkriseis-structure',
  'load-project-egkriseis','load-prosklisi-modifications','load-subproject-links',
  'load-unlinked-egkriseis','open-document-template','open-egkrisi-v2-pdf',
  'open-file-dialog','open-pdf-file','open-prosklisi-folder','register-user',
