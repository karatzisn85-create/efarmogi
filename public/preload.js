...
const ALLOWED_INVOKE = new Set([
  ...
  'open-file-dialog','open-note-file','open-pdf-file','open-prosklisi-folder','open-task-assignment-file','download-task-assignment-file','preview-subprojects-excel-import','register-user',
  ...
  'select-data-folder','select-file','select-folder','select-folder-files-flat','select-multiple-files','select-subprojects-import-xlsx','set-dashboard-session-active',
