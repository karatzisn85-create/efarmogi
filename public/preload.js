...
const ALLOWED_INVOKE = new Set([
  ...
  'download-subproject-file','download-update','export-invest-projects','export-prosklisi','export-proskliseis-excel','export-proskliseis-orimanthi-excel','export-proskliseis-pdf',
  ...
  'upload-proposal-files','upload-proposal-folder','set-proposal-group-permit-issued','set-proposal-file-prosklisi-link','delete-proposal-file','delete-proposal-folder-file','rename-proposal-file','delete-proposal-folder','delete-proposal-group','move-proposal-entry','open-proposal-file','download-proposal-file','get-proposal-folder-files','get-proposal-files','export-proposal','log-proposal-activity','clear-proposal-audit-log','search-proposal-files',
