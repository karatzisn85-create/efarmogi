...
const ALLOWED_INVOKE = new Set([
  ...
  'link-ep-subproject',
  'export-ep-program',
  'download-ep-program-template',
  'get-ep-program-statistics',
  'get-ep-subproject-link-map',
  'open-exported-file','open-external-url','open-khmdhs-act-view','prefetch-khmdhs-act-pdfs',
  ...
  'upload-contractor-registry-files','get-contractor-registry-files','open-contractor-registry-file','delete-contractor-registry-file',
  'load-site-diary-hub','get-site-diary-entry-counts','get-subproject-site-diary',
  'add-site-diary-entry','update-site-diary-entry','delete-site-diary-entry',
  'select-site-diary-photos','add-site-diary-photos','delete-site-diary-photo',
  'resolve-site-diary-photos','open-site-diary-photo',
