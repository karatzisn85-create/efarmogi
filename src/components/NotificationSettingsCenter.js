...
export default function NotificationSettingsCenter({ onClose, currentUser }) {
  ...
  const renderCalendarTab = () => (
    <>
      <InfoBox>
        Ρυθμίστε ποιοι χρήστες θα λαμβάνουν email υπενθυμίσεις για τις προθεσμίες
        του ημερολογίου (ΚΗΜΔΗΣ, λήξη συμβάσεων, προσφορές, κ.λπ.). Τα emails
        στέλνονται αυτόματα τις ημέρες που θα ορίσετε.
      </InfoBox>
      ...
      <Section>
        <SectionTitle>Τύποι γεγονότων που ειδοποιούν</SectionTitle>
        ...
        <HelpText>
          Επιλέξτε ποιοι τύποι γεγονότων θα στέλνουν email. Αν δεν σας αφορούν
          π.χ. οι προσφορές, μπορείτε να τις αφήσετε ανενεργές.
        </HelpText>
      </Section>
