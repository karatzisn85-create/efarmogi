...
export const getProsklisiSyncedFieldsAfterRemoval = prosklisiCatalog.getProsklisiSyncedFieldsAfterRemoval;
export const getProsklisiSyncedFieldsFromModification = prosklisiCatalog.getProsklisiSyncedFieldsFromModification;
...
export const normalizeProsklisiStatus = prosklisiCatalog.normalizeProsklisiStatus;
export const PROSKLISI_STATUS_OPTIONS = prosklisiCatalog.PROSKLISI_STATUS_OPTIONS;
export const PROSKLISI_STATUS_SUBMITTED = prosklisiCatalog.PROSKLISI_STATUS_SUBMITTED;
...
export const uniqueLinkedOrimanthiTitles = prosklisiCatalog.uniqueLinkedOrimanthiTitles;
export const findProskliseisLinkedToOrimanthi = prosklisiCatalog.findProskliseisLinkedToOrimanthi;
export const findOrimanthiLinksForProject = prosklisiCatalog.findOrimanthiLinksForProject;
export const linkedProjectIdentity = prosklisiCatalog.linkedProjectIdentity;
export const normalizeLinkedProjects = prosklisiCatalog.normalizeLinkedProjects;
export const linkedOrimanthiTitlesOf = prosklisiCatalog.linkedOrimanthiTitlesOf;
export const normalizeLinkedOrimanthiProposals = prosklisiCatalog.normalizeLinkedOrimanthiProposals;
export const detachOrimanthiProposal = prosklisiCatalog.detachOrimanthiProposal;
...
export const toProsklisiDateInputValue = prosklisiCatalog.toProsklisiDateInputValue;
export const resolveProsklisiModificationFormValues = prosklisiCatalog.resolveProsklisiModificationFormValues;
export const sameProsklisiFormValue = prosklisiCatalog.sameProsklisiFormValue;
export const formatProsklisiChangeValue = prosklisiCatalog.formatProsklisiChangeValue;
